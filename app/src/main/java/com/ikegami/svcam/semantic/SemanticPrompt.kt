...
For objects, return at most 16 important and diverse objects in descending visual importance.
Avoid using all object slots for repeated instances of the same category unless those instances are genuinely important.
